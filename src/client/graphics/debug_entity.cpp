...
DebugEntity::DebugEntity(TextureController controller, float x, float y, float width, float height):
...
void DebugEntity::render(SDL2pp::Renderer& renderer, SDL2pp::Rect& camera) {
    SDL2pp::Point center;
    ...
    renderer.Copy(*texture, SDL2pp::Rect(0, 0, (*texture).GetWidth(), (*texture).GetHeight()),
                  SDL2pp::Rect(x * (640 / 20), -y * (480 / 20) + 480 + 50, 150, 50), 0, center, 0);
}
void DebugEntity::update_info(EntityInfo* info) { Entity::update_info(info); }

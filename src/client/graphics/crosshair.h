...
public:
    ...
    void render_by_angle(SDL2pp::Renderer& renderer, int player_x, int player_y, float aim_angle);

    // Dibuja el crosshair en la posicion pasada por parametro
    void render_by_coordinates(SDL2pp::Renderer& renderer, float x, float y);
};

...
#ifndef WORMS_SERVER_WEAPON_REDGRENADE_H
#define WORMS_SERVER_WEAPON_REDGRENADE_H

#include <memory>

#include "server_weapon.h"

class RedGrenadeWeapon: public Weapon {
private:
    float countdown;
    float aim_angle;
    float aim_power;
...
public:
    ...
    explicit RedGrenadeWeapon(GameWorld& world);
...
#endif  // WORMS_SERVER_WEAPON_REDGRENADE_H
